...
const weatherView = (() => {
  ...
  async function setWeatherDataObject(localization) {
    weatherDataObject = await (0,_dataController__WEBPACK_IMPORTED_MODULE_2__["default"])(localization);
    renderWeatherData();
  }
